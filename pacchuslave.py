...
serverlist = {}
version = "v0.4.2 alpha : mongodb branch"
...
async def on_ready():
    ...
    statustxt = "Testing new database ;)"
    ...
    if(message.content.startswith('!emoji')):
        ...
        for ej in client.emojis:
            if(ej.name == emname):
                ...
                embed.set_footer(text="love from Pacchu's Slave")
                await message.channel.send(embed=embed)
                break
...
client.run("NzA5NDI2MDE1NzU5MzY4Mjgy.Xrludg.Rufk480fJ2c2oW3iub3DBI4wfyI")